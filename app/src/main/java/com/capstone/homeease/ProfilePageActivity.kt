...
import com.capstone.homeease.databinding.ActivityProfilePageBinding
...
class ProfilePageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.deleteAccountText.setOnClickListener {
            val intent = Intent(this, UserDeleteAccountActivity::class.java)
            startActivity(intent)
        }
        ...
        binding.manageRewardsText.setOnClickListener{
